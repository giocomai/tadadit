---
title: "Prigozhin's audio files, transcribed"
description: "N.B. Automatic transcription, not checked for accuracy"
...
id_with_audio_files <- transcribed_ru_df |>
  dplyr::arrange(id) |> 
  dplyr::distinct(id) |>
  dplyr::pull(id)
```
...
for (i in id_with_audio_files) {
  ...
  section_link <- stringr::str_c("./prigozhin_transcribed_en.qmd#", section_id_string)
  ...
  if (current_language=="ru") {
    ...
    cat("</p>")
    cat("<p>")
      cat(stringr::str_c("*[See this post transcribed and translated in English](", section_link, ")*"))
      cat(" <br />")
       cat("</p>")
  }
