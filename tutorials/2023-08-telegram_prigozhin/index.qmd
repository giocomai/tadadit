...
__Earliest post__: `r min(messages_df$date)`

__Latest post__: `r max(messages_df$date)`

__Total number of posts__: `r scales::number(nrow(messages_df))`
...
## Step 2: An overview of data extracted
