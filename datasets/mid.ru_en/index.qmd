---
title: "mid.ru_en"
description: "All English-languge news items published on the website of the Russian Ministry of Foreign Affairs"
...
body_text <- stringr::str_c(
  "**Dataset name**: mid.ru_en",
  "**Dataset description**: All English-language news items published on the website of the Russian MFA",
  ...
  stringr::str_c(collapse = "; ")),
    ...
    paste("**Link for download**: [mid.ru_en](https://github.com/giocomai/tadadit/releases/tag/mid.ru_en)"),
                            sep = "\n\n")
