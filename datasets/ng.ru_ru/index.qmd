---
title: "ng.ru_ru"
description: "All items published on Nezavisimaya Gazeta"
...
body_text <- stringr::str_c(
  "**Dataset name**: ng.ru_ru",
  "**Dataset description**: all artciles published on *Nezavisimaya Gazeta* starting with 2018",
...
corpus_df |>
  ...
  labs(
    title = "Number of items per year published on Nezavisimaya Gazeta (ng.ru)",
...
words_per_day_df |> 
  ...
  scale_y_continuous(name = "", labels = scales::number) +
  scale_x_continuous(name = "", breaks = scales::pretty_breaks(n = 6)) +
  labs(title = "Number of words per year published on Nezavisimaya Gazeta (ng.ru)",
