---
title: "kp.ru_ru"
description: "All items published in the politics section of Komsomolskaya Pravda"
...
body_text <- stringr::str_c(
  "**Dataset name**: kp.ru_ru",
  "**Dataset description**: all articles published in the politics section of *Komsomolskaya Pravda* starting with 2000",
...
corpus_df |>
  ...
  labs(
    title = glue::glue("Number of items per year published in the {sQuote('politics')} section of *Komsomolskaya Pravda* (kp.ru)"),
...
words_per_day_df |> 
  ...
  scale_y_continuous(name = "", labels = scales::number) +
  scale_x_continuous(name = "", breaks = scales::pretty_breaks(n = 6)) +
  labs(title = glue::glue("Number of words per year published in the {sQuote('politics')} section of *Komsomolskaya Pravda* (kp.ru)"),
