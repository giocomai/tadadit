...
- Almost all news items are published with an identifier, e.g. "1383-22-09-2011" for [this item](https://www.mid.ru/ru/foreign_policy/news/1607500/). In many instances, in particular in the earlier years, the identifier is missing, and in a handful it is not unique. As a consequence, the numeric component of the url is likely preferable as the main unique identifier.
