---
title: "duma.gov.ru_2024"
description: "Russia's Duma website (in Russian, 2006-2023)"
author: Giorgio Comai
date: 2024-03-21
last-modified: 2024-03-21
categories: [dataset, Russian institutions, Duma, Russian language]
editor: source
---
...
summary_stats_text <- stringr::str_c(
  ...
  "**Dataset description**: all items published in Russian on the website of Russia's Duma",
...
corpus_df |>
  ...
  labs(
    title = "Number of items per year published on the website of Russia's Duma",
...
words_per_day_df |> 
  ...
  scale_y_continuous(name = "", labels = scales::number) +
  scale_x_continuous(name = "", breaks = scales::pretty_breaks(n = 10)) +
  labs(title = "Number of words per year published on the website of Russia's Duma",
...
corpus_df <- corpus_df |> 
  ...
  dplyr::ungroup() |> 
  dplyr::relocate(doc_id, text, date, datetime, title, internal_id) |> 
