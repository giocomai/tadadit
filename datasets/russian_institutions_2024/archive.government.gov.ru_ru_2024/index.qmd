---
title: "archive.government.gov.ru_ru_2024"
description: "Archived version of Russia's government website (Russian version, 2008-2013)"
...
cas_set_options(
  ...
  website = "archive.government.gov.ru_ru" 
)
...
The contents of this dataset - “archive.government.gov.ru_ru” - are distributed within the remits of this license. To the extent that it is possible, the dataset itself is also distributed by its creator, Giorgio Comai, with the same CC-BY license, as well as under the Open Data Commons Attribution license (ODC-BY).
...
summary_stats_text <- stringr::str_c(
  ...
  "**Dataset description**: all items published on archive.government.gov.ru",
...
corpus_df |>
  ...
  labs(
    title = "Number of items per year published on the Russian-language version of archive.government.gov.ru",
...
words_per_day_df |> 
  ...
  scale_y_continuous(name = "", labels = scales::number) +
  scale_x_continuous(name = "", breaks = scales::pretty_breaks(n = 5)) +
  labs(title = "Number of words per year published on the Russian-language version of archive.government.gov.ru",
