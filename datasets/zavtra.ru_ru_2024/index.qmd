...
This corpus is based on the website of Russian weekly newspaper [zavtra.ru](http://zavtra.ru/). More specifically, according to the ["about" page of the website](https://zavtra.ru/about), the website zavtra.ru "appeared on the basis of the digital version of the newspaper 'Zavtra'".
...
- the date of publication included in such cases may be off by a few days with the date of publication reported above the title
- the issue number may also be off by one, e.g. this inline text makes reference to issue 228, but is linked from the archive from the page of issue 227. 
- a very small number of issues includes only one article

Here is an example showing all of the above issues. 

[Issue 227](https://zavtra.ru/archive/1998/4/227), available from the archive page related to [1998](https://zavtra.ru/archive/1998), includes only [one article](https://zavtra.ru/blogs/1998-04-1711anshl). This [article](https://zavtra.ru/blogs/1998-04-1711anshl), includes at the very beginning of its text the title, and then the following string: "15 (228) Date: 17–04–98". This would suggest that the article was originally published on 17 April 1998 and belonged to issue 228. Yet on the very same page, 13 April 1998 is presented as date of publication, and the article is linked from the archive page of issue 227. Metadata in the corpus would consistently rely on website metadata, hence would keep these latter points of reference. 

These issues are likely of negligibile impact for analyses looking at long term trends, but should be kept in consideration by researchers for whom exact time of publication is of the essence. Time of publication (hour and minute) should probably be disregarded for earlier years: the 3.00am time of publication reported for many articles is probably just an artifact of importing contents from previous versions of the website, which may have assumed GMT as default time. Again, as these are the metadata currently visible online, they have been dutifully been included in the published corpus, but should be looked at with caution.. 

The vast majority of newspaper issues includes between 15 and 30 articles (see graph below). In a small number of cases, as mentioned above, only one article is included in each issue. This may or may not hint at missing articles (perhaps, these were actually published as double issues, and the lone remaining article has been mis-attributed to an effectively non-existent issue). No additional checks have been conducted on these outliers. 
