---
title: "novostipmr.com_ru"
description: "All items published on the website of Transnistria's news agency Novosti PMR"
author: Giorgio Comai
date: 2023-10-10
last-modified: 2023-10-10
categories: [dataset, Russian language, Transnistria]
---
...
corpus_df |>
  ...
  labs(
    title = "Number of items per year published on the website of Transnistria's news agency Novosti PMR",
...
words_per_day_df |> 
  ...
  scale_y_continuous(name = "", labels = scales::number) +
  scale_x_continuous(name = "", breaks = scales::pretty_breaks(n = 6)) +
  labs(title = "Number of words per year published on the website of Transnistria's news agency Novosti PMR",
