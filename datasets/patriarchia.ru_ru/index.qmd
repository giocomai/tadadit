---
title: "patriarhia.ru_ru"
description: "All items published on the official website of the Moscow Patriarchate"
author: Giorgio Comai
date: 2023-09-18
last-modified: 2023-09-18
categories: [dataset, Russian language]
---
...
body_text <- stringr::str_c(
  "**Dataset name**: patriarhia.ru_ru",
  "**Dataset description**: All items published on the official website of the Moscow Patriarchate",
...
corpus_df |>
  ...
  labs(
    title = "Number of items per year published on the website of the Moscow Patriarchate",
...
words_per_day_df |> 
  ...
  scale_y_continuous(name = "", labels = scales::number) +
  scale_x_continuous(name = "", breaks = scales::pretty_breaks(n = 6)) +
  labs(title = "Number of words per year published on the website of the Moscow Patriarchate",
